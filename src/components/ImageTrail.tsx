    ...
    gsap
      ...
      .to(
        img.DOM.el,
        {
          duration: 0.4,
          ease: "power3",
          opacity: 0.6, // Keep more visible
          scale: 0.9, // Keep larger and more visible
        },
        0.4
      );
  }
...
export default function ImageTrail({
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      'Full Stack Developer': '#272727',
      'Frontend Developer': '#00704a', 
      'Backend Developer': '#272727',
      'Mobile App Developer': '#00704a',
      'UI/UX Designer': '#059669',
      'Data Scientist': '#272727',
      'DevOps Engineer': '#00704a',
      'Machine Learning Engineer': '#272727',
      'Product Manager': '#dc2626',
      'Graphic Designer': '#059669',
      'Software Architect': '#272727',
      'QA Engineer': '#00704a',
      'Blockchain Developer': '#272727',
      'Cybersecurity Specialist': '#00704a',
      'Cloud Engineer': '#272727',
      'Game Developer': '#00704a',
      'Technical Writer': '#ea580c',
      'Digital Marketer': '#ea580c',
      'SEO Specialist': '#ea580c',
      'Content Creator': '#dc2626'
    };
  ...
  const getCategoryBg = (category: string) => {
    const backgrounds = {
      'Full Stack Developer': '#f7fafc',
      'Frontend Developer': '#f0fdf4', 
      'Backend Developer': '#f7fafc',
      'Mobile App Developer': '#f0fdf4',
      'UI/UX Designer': '#ecfdf5',
      'Data Scientist': '#f7fafc',
      'DevOps Engineer': '#f0fdf4',
      'Machine Learning Engineer': '#f7fafc',
      'Product Manager': '#fee2e2',
      'Graphic Designer': '#ecfdf5',
      'Software Architect': '#f7fafc',
      'QA Engineer': '#f0fdf4',
      'Blockchain Developer': '#f7fafc',
      'Cybersecurity Specialist': '#f0fdf4',
      'Cloud Engineer': '#f7fafc',
      'Game Developer': '#f0fdf4',
      'Technical Writer': '#fff7ed',
      'Digital Marketer': '#fff7ed',
      'SEO Specialist': '#fff7ed',
      'Content Creator': '#fee2e2'
    };
    return backgrounds[category as keyof typeof backgrounds] || '#f7fafc';
  };

  return (
    <div className="content" ref={containerRef}>
      {items.map((jobTitle, i) => (
        <div className="content__img" key={i}>
          <div
            className="content__img-inner"
            style={{
              backgroundColor: getCategoryBg(jobTitle),
              color: getCategoryColor(jobTitle),
              display: 'flex',
              alignItems: 'center',
              ...
              textAlign: 'center',
              border: `2px solid ${getCategoryColor(jobTitle)}20`,
